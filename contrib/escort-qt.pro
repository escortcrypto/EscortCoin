...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/escortcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/escortcoin-cli.cpp \
           src/escortcoin-tx.cpp \
           src/escortcoin.cpp \
           src/db.cpp \
           ...
           src/qt/escortcoin.cpp \
           src/qt/escortcoinstrings.cpp \
...
RESOURCES += src/qt/escortcoin.qrc src/qt/escortcoin_locale.qrc

TRANSLATIONS += src/qt/locale/escortcoin_bg.ts \
                src/qt/locale/escortcoin_de.ts \
                src/qt/locale/escortcoin_en.ts \
                src/qt/locale/escortcoin_es.ts \
                src/qt/locale/escortcoin_fi.ts \
                src/qt/locale/escortcoin_fr.ts \
                src/qt/locale/escortcoin_it.ts \
                src/qt/locale/escortcoin_ja.ts \
                src/qt/locale/escortcoin_pl.ts \
                src/qt/locale/escortcoin_pt.ts \
                src/qt/locale/escortcoin_ru.ts \
                src/qt/locale/escortcoin_sk.ts \
                src/qt/locale/escortcoin_sv.ts \
                src/qt/locale/escortcoin_vi.ts \
                src/qt/locale/escortcoin_zh_CN.ts \
                src/qt/locale/escortcoin_zh_TW.ts
