...
Intro
-----
EscortCoin (EAPC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. EscortCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run escortcoin-qt.exe.

EscortCoin Core is the original EscortCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of EscortCoin transactions;
