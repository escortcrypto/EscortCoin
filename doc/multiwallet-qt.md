...
In order to support loading of multiple wallets in escortcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is escortcoin.cpp.
...
Changes to escortcoin.cpp
----------------------
escortcoin.cpp is the entry point into escortcoin-qt, and as such, will require some minor modifications to provide hooks for
