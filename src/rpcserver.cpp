...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "EscortCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EscortCoin features */
        {"escortcoin", "masternode", &masternode, true, true, false},
        {"escortcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"escortcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"escortcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"escortcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"escortcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"escortcoin", "startmasternode", &startmasternode, true, true, false},
        {"escortcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"escortcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"escortcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"escortcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"escortcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"escortcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"escortcoin", "mnbudget", &mnbudget, true, true, false},
        {"escortcoin", "preparebudget", &preparebudget, true, true, false},
        {"escortcoin", "submitbudget", &submitbudget, true, true, false},
        {"escortcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"escortcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"escortcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"escortcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"escortcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"escortcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"escortcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"escortcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"escortcoin", "mnsync", &mnsync, true, true, false},
        {"escortcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> escortcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9697/\n";
}
