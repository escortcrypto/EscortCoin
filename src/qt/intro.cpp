...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("EscortCoin Core"),
     ...
     * override -datadir in the escortcoin.conf file in the default data directory
     * (to be consistent with escortcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
