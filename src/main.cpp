...
#if defined(NDEBUG)
#error "EscortCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uEAPC) are considered zero fee (for relaying and mining)
...
{
    RenameThread("escortcoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // EAPC: We use certain sporks during IBD, so check to see if they are
