...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("EscortCoin Core escortcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  escortcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded escortcoin transaction") + "\n" +
                               "  escortcoin-tx [options] -create [commands]   " + _("Create hex-encoded escortcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded escortcoin transaction
