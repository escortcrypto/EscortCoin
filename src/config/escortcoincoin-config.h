/* src/config/escortcoin-config.h.  Generated from escortcoin-config.h.in by configure.  */
/* src/config/escortcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef EAPC_CONFIG_H

#define EAPC_CONFIG_H
...
#define PACKAGE_NAME "EscortCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "EscortCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "escortcoin"
