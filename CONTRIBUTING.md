Contributing to EscortCoin Core
==================================

The EscortCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EscortCoin Core project, and is not to be
confused with overall EscortCoin Network Protocol consensus changes.

Whether a pull request is merged into EscortCoin Core rests with the project merge
...
Patches that change EscortCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the EscortCoin consensus, it must have been
...
The project leader is the release manager for each EscortCoin Core release.
